...
-- LOGIC: Source Qualifier, Data Quality Expression, three LKP_USERID_NAME calls, target lookup, Router, Update Strategy, and both target branches
-- SOURCE Tables: CRPDB01_DEV_SANDBOX.EPMADM.PS_Z_CI_GEN_STAT, CRPDB01_DEV_SANDBOX.EPMADM.PS_PERSONAL_D00
-- TARGET TABLE: CRPDB01_DEV_SANDBOX.EPMADM.PS_Z_CI_GEN_STAT
-- PRE SQL: None
-- POST SQL: None
-- Parameters used: $Source, $Target, $PMCacheDir

MERGE INTO CRPDB01_DEV_SANDBOX.EPMADM.PS_Z_CI_GEN_STAT t
USING
(
    SELECT
        exp.*,
    ...
    (
        ...
        (
            SELECT
                *
            FROM CRPDB01_DEV_SANDBOX.EPMADM.PS_Z_CI_GEN_STAT
        ) sq
        LEFT JOIN (
                SELECT
                    SETID,
                    ...
                    ALTER_EMPLID,
                    PERS_NAME
                FROM CRPDB01_DEV_SANDBOX.EPMADM.PS_PERSONAL_D00
