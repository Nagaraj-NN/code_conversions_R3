...
{{ config(
    ...
    pre_hook=[
        log_model_start(this, 'TBD_PS_Z_JOB_CONTROL_UPD_DTTM', target_object='CRPDB01.EPMADM.PS_Z_JOB_CONTROL')
    ],
    post_hook=[
     ...
     SET TABLE_NAME = TABLE_NAME,
         ...
         STATUS = 'R'
     WHERE JOBID = 'CPP_D00'",
        log_model_end(this, 'TBD_PS_Z_JOB_CONTROL_UPD_DTTM', target_object='CRPDB01.EPMADM.PS_Z_JOB_CONTROL')
    ]
) }}
