...
{{ config(
    ...
    pre_hook=[
        log_model_start(this, 'TBD_PS_Z_CPP_GEN_STAT_INS', target_object=target.database ~ '.EPMADM.PS_Z_CPP_GEN_STAT')
    ],
    post_hook=[
     ...
     (
        ...
        log_model_end(this, 'TBD_PS_Z_CPP_GEN_STAT_INS', target_object=target.database ~ '.EPMADM.PS_Z_CPP_GEN_STAT')
    ]
) }}
