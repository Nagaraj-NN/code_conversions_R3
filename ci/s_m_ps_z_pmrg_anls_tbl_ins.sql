...
-- Mappings Name: m_ps_z_ci_pmrg_anls_tbl_ins
...
-- SOURCE Tables: PS_Z_PMRG_ANLS_TBL
-- TARGET TABLE: PS_Z_PMRG_ANLS_TBL
-- PRE SQL: None
-- POST SQL: None
-- Parameters used: $Source, $Target, $PMCacheDir

MERGE INTO CRPDB01_DEV_SANDBOX.EPMADM.PS_Z_PMRG_ANLS_TBL t
USING (
        SELECT
            exp.*,
        ...
        FROM CRPDB01_DEV_SANDBOX.EPMADM.PS_Z_PMRG_ANLS_TBL src
        ) exp
        LEFT JOIN (
            SELECT
                BUSINESS_UNIT,
                ...
                REVISION_NUMBER,
                Z_LOB
            FROM CRPDB01_DEV_SANDBOX.EPMADM.PS_Z_PMRG_ANLS_TBL
            GROUP BY
                BUSINESS_UNIT,
                PROJECT_ID,
                REVISION_NUMBER,
