...
-- Mappings Name: m_ps_z_cpp_gen_stat_ins
...
-- SOURCE Tables: CRPDB01_DEV_SANDBOX.EPMADM.PS_Z_CPP_GEN_STAT, CRPDB01_DEV_SANDBOX.EPMADM.PS_PERSONAL_D00
-- TARGET TABLE: CRPDB01_DEV_SANDBOX.EPMADM.PS_Z_CPP_GEN_STAT
-- PRE SQL: None
-- POST SQL: None
-- Parameters used: $Source, $Target, $PMCacheDir

MERGE INTO CRPDB01_DEV_SANDBOX.EPMADM.PS_Z_CPP_GEN_STAT t
USING
(
    SELECT
        exp.*,
    ...
    (
        ...
        (
            SELECT
                *
            FROM CRPDB01_DEV_SANDBOX.EPMADM.PS_Z_CPP_GEN_STAT
        ) sq
        LEFT JOIN (
                SELECT
                    SETID,
