...
-- SOURCE Tables: PS_Z_PDS_CPP_VW
-- TARGET TABLE: PS_Z_PDS_CPP_DTL
-- PRE SQL: None
-- POST SQL: None
-- Parameters used: $Source, $Target, $PMCacheDir

MERGE INTO CRPDB01_DEV_SANDBOX.EPMADM.PS_Z_PDS_CPP_DTL t
USING (
        SELECT
            exp.*,
        ...
        FROM CRPDB01_DEV_SANDBOX.EPMADM.PS_Z_PDS_CPP_VW src
        ) exp
        LEFT JOIN (
            SELECT
                Z_CPP_ID,
                ...
                FISCAL_YEAR,
                Z_CI_COST_CATG
            FROM CRPDB01_DEV_SANDBOX.EPMADM.PS_Z_PDS_CPP_DTL
            GROUP BY
                Z_CPP_ID,
                REVISION_NUMBER,
                FISCAL_YEAR,
