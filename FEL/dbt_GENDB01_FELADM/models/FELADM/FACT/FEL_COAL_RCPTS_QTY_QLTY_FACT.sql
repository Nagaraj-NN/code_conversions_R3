-- ==========================================================================
-- Model      : FEL_COAL_RCPTS_QTY_QLTY_FACT
...
-- --------------------------------------------------------------------------
-- INSERT + UPDATE, data driven. RTR_NEW_EXIST splits on the target fact
...
{{ config(
    materialized='table',
    alias='FEL_COAL_RCPTS_QTY_QLTY_FACT_SRC',
    meta={"mapping_name": "m_FEL_COAL_RCPTS_QTY_QLTY_FACT_ins_upd", "workflow_name": "wkf_FEL_COAL_FACT_LOAD", "session_name": "s_m_FEL_COAL_RCPTS_QTY_QLTY_FACT_ins_upd"},
    pre_hook=[
        log_model_start(this, 'TBD_FEL_COAL_RCPTS_QTY_QLTY_FACT', target_object='GENDB01.FELADM.FEL_COAL_RCPTS_QTY_QLTY_FACT')
    ],
    post_hook=[
        "UPDATE {{ source('GENDB01_FELADM','FEL_COAL_RCPTS_QTY_QLTY_FACT') }} TGT
     SET
     ...
     WHERE TGT.RECEIPT_KEY = SRC.RECEIPT_KEY
       AND (   SRC.FDR_LAST_UPDT_TS >= TO_TIMESTAMP_NTZ('09/02/2026 22:30:11', 'MM/DD/YYYY HH24:MI:SS')
        ...
        "INSERT INTO {{ source('GENDB01_FELADM','FEL_COAL_RCPTS_QTY_QLTY_FACT') }} (
         RECEIPT_KEY,
         SHP_DT_ID,
         UNLOADD_DT_ID,
         PRCD_DT_ID,
     ...
     WHERE NOT EXISTS (
         SELECT 1
         FROM {{ source('GENDB01_FELADM','FEL_COAL_RCPTS_QTY_QLTY_FACT') }} L
         WHERE L.RECEIPT_KEY = SRC.RECEIPT_KEY
     )",
        log_model_end(this, 'TBD_FEL_COAL_RCPTS_QTY_QLTY_FACT', target_object='GENDB01.FELADM.FEL_COAL_RCPTS_QTY_QLTY_FACT')
    ]
) }}
