...
{{ config(
    ...
    full_refresh=false,
    meta={"mapping_name": "m_FEL_JO_RCPT_BRDG_ins", "workflow_name": "wkf_FEL_COAL_FACT_LOAD", "session_name": "s_m_FEL_JO_RCPT_BRDG_ins"},
    pre_hook=[
        log_model_start(this, 'TBD_FEL_JO_RCPT_BRDG', target_object='GENDB01.FELADM.FEL_JO_RCPT_BRDG'),
        "TRUNCATE TABLE IF EXISTS {{ this }}"
    ],
    post_hook=[
        log_model_end(this, 'TBD_FEL_JO_RCPT_BRDG', target_object='GENDB01.FELADM.FEL_JO_RCPT_BRDG')
    ]
) }}
