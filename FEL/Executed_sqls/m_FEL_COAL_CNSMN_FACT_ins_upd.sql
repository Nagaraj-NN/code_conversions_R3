...
--------------------------------------------------------------------------------
 SOURCE    : GENDB01.FELADM.FEL_COAL_CNSMN_FDR   source filter on status
 LOOKUPS   : GENDB01.FELADM.FEL_SAMPLED_DIM
 ...
 TARGET    : GENDB01.FELADM.FEL_COAL_CNSMN_FACT   insert and update instances
--------------------------------------------------------------------------------
...
UPDATE GENDB01.FELADM.FEL_COAL_CNSMN_FACT TGT
SET
...
FROM (
    ...
    FROM (
        ...
        FROM GENDB01.FELADM.FEL_COAL_CNSMN_FDR SQ
...
INSERT INTO GENDB01.FELADM.FEL_COAL_CNSMN_FACT (
    RECLAIM_KEY,
    RECLAIM_ID,
    UNIT_KEY,
    INVTRY_LOC_KEY,
...
SELECT
    NVL((SELECT MAX(RECLAIM_KEY) FROM GENDB01.FELADM.FEL_COAL_CNSMN_FACT), 0)
...
WHERE NOT EXISTS (
    SELECT 1
    FROM GENDB01.FELADM.FEL_COAL_CNSMN_FACT L
