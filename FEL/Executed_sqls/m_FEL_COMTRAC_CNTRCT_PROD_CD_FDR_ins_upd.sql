...
--------------------------------------------------------------------------------
 SOURCE    : AEP_DW_CONTRACTDTL_VW
             GENDB01_DEV_SANDBOX.COMMON.AEP_DW_CONTRACTDTL_VW_TEST (USED FOR TESTING)
 LOOKUP    : GENDB01.FELADM.FEL_COMTRAC_CNTRCT_PROD_CD_FDR
 TARGET    : GENDB01.FELADM.FEL_COMTRAC_CNTRCT_PROD_CD_FDR   insert and update instances
--------------------------------------------------------------------------------
...
UPDATE GENDB01.FELADM.FEL_COMTRAC_CNTRCT_PROD_CD_FDR TGT
SET
...
FROM (
    ...
    FROM (
        SELECT
            ...
            SQ.EXP_DT,
            SQ.MOD_DT
        FROM GENDB01_DEV_SANDBOX.COMMON.AEP_DW_CONTRACTDTL_VW_TEST SQ  --USED FOR TESTING
    ...
    JOIN (
        ...
        FROM GENDB01.FELADM.FEL_COMTRAC_CNTRCT_PROD_CD_FDR FDR
...
INSERT INTO GENDB01.FELADM.FEL_COMTRAC_CNTRCT_PROD_CD_FDR (
    CNTRCT_DTL_ID,
    CONTRACT_CD,
    PRODUCT_CD,
    PRODUCT_NM,
