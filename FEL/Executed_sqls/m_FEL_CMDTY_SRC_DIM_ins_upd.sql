...
--------------------------------------------------------------------------------
 SOURCE    : feladm.FEL_CMDTY_SRC_FDR
             GENDB01.FELADM.FEL_CMDTY_SRC_FDR  (USED FOR TESTING)
 LOOKUPS   : GENDB01.FELADM.FEL_CMDTY_SRC_DIM  (USED FOR TESTING)
 TARGET    : GENDB01.FELADM.FEL_CMDTY_SRC_DIM  (USED FOR TESTING) insert and update instances
--------------------------------------------------------------------------------
...
UPDATE GENDB01.FELADM.FEL_CMDTY_SRC_DIM TGT
SET
...
FROM (
    SELECT
        ...
        CAST(IFF(LKP_KEY.CMDTY_SRC_KEY IS NOT NULL, LKP_KEY.CMDTY_SRC_KEY,
                 NVL((SELECT MAX(CMDTY_SRC_KEY) FROM GENDB01.FELADM.FEL_CMDTY_SRC_DIM), 0)
...
INSERT INTO GENDB01.FELADM.FEL_CMDTY_SRC_DIM (
    ALLOCATED_ID,
    CMDTY_SRC_ID,
    CMDTY_SRC_EFCTV_DT,
    CMDTY_SRC_EXPR_DT,
...
WHERE NOT EXISTS (
    SELECT 1
    FROM GENDB01.FELADM.FEL_CMDTY_SRC_DIM L
