...
UPDATE GENDB01.FELADM.FEL_COAL_RCPTS_COST_FACT TGT
SET
...
FROM (
    ...
    FROM (
        ...
        FROM (
            SELECT
                ...
                Q.MOISTURE_QLTY_PCT,
                Q.BTU_PER_LB_MSR
            FROM GENDB01.FELADM.FEL_COAL_RCPTS_QTY_QLTY_FDR Q,
                 GENDB01.FELADM.FEL_COAL_RCPTS_COST_FDR C
    ...
    LEFT JOIN (
        ...
        FROM GENDB01.FELADM.FEL_COST_CMPNT_DIM D
...
INSERT INTO GENDB01.FELADM.FEL_COAL_RCPTS_COST_FACT (
    RECEIPT_KEY,
    CST_CMPNT_KEY,
    SHP_DT_ID,
    UNLOADD_DT_ID,
...
WHERE NOT EXISTS (
    SELECT 1
    FROM GENDB01.FELADM.FEL_COAL_RCPTS_COST_FACT L
