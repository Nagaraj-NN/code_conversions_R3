...
--------------------------------------------------------------------------------
 SOURCE    : GENDB01.FELADM.FEL_FV_BEGBAL_FDR
...
TRUNCATE TABLE GENDB01.FELADM.FEL_FV_BEGBAL_FACT;

INSERT INTO GENDB01.FELADM.FEL_FV_BEGBAL_FACT (
    ACCTG_MO_DAY_ID,
...
FROM (
    SELECT
        ...
        (SELECT MIN(DIM.TRAN_CLS_KEY)
           FROM GENDB01.FELADM.FEL_TRAN_CLASS_DIM DIM
    ...
    FROM (
        ...
        FROM GENDB01.FELADM.FEL_FV_BEGBAL_FDR f
        INNER JOIN (
            SELECT
                ACCTG_MO_DAY_ID,
                INVTRY_LOC_ID,
            ...
            FROM GENDB01.FELADM.FEL_FV_BEGBAL_FDR
