...
--------------------------------------------------------------------------------
 SOURCE    : GENDB01.FELADM.FEL_COAL_CNSMN_FACT   full read, no filter
 LOOKUP    : GENDB01.FELADM.FEL_COAL_CNSMN_FDR
             ...
             lookup SQL override PRESENT:
               ...
               FROM GENDB01.FELADM.FEL_COAL_CNSMN_FDR F
...
DELETE FROM GENDB01.FELADM.FEL_COAL_CNSMN_FACT TGT
WHERE NOT EXISTS (
    SELECT 1
    FROM GENDB01.FELADM.FEL_COAL_CNSMN_FDR F
