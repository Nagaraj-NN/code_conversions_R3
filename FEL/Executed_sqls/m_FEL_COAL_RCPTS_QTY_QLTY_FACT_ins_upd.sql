...
--------------------------------------------------------------------------------
 SOURCE    : GENDB01.FELADM.FEL_COAL_RCPTS_QTY_QLTY_FDR   source filter on status
 LOOKUPS   : GENDB01.FELADM.FEL_RECEIPT_DIM
             ...
             GENDB01.FELADM.FEL_COMTRAC_CONTRACT_FDR
             GENDB01.FELADM.FEL_CONTRACT_DIM
             GENDB01.FELADM.FEL_CMDTY_SRC_DIM
             GENDB01.FELADM.FEL_BSNS_ENTY_DIM
             GENDB01.FELADM.FEL_SAMPLED_DIM
             GENDB01.FELADM.FEL_SYSTEM_DIM
 TARGET    : GENDB01.FELADM.FEL_COAL_RCPTS_QTY_QLTY_FACT   insert and update instances
--------------------------------------------------------------------------------
...
UPDATE GENDB01.FELADM.FEL_COAL_RCPTS_QTY_QLTY_FACT TGT
SET
...
FROM (
    ...
    FROM (
        SELECT
            ...
            IFF((SELECT MIN(SAMPLED_KEY) FROM GENDB01.FELADM.FEL_SAMPLED_DIM
                ...
                IFF(SQ.ASH_QLTY_PCT <> 0 OR SQ.SULFUR_QLTY_PCT <> 0
                 OR SQ.MOISTURE_QLTY_PCT <> 0 OR SQ.BTU_PER_LB_MSR <> 0,
                    (SELECT MIN(SAMPLED_KEY) FROM GENDB01.FELADM.FEL_SAMPLED_DIM WHERE SMPLD_RSN_TX = 'Sampled'),
                    (SELECT MIN(SAMPLED_KEY) FROM GENDB01.FELADM.FEL_SAMPLED_DIM WHERE SMPLD_RSN_TX = 'Unknown')),
                (SELECT MIN(SAMPLED_KEY) FROM GENDB01.FELADM.FEL_SAMPLED_DIM
    ...
    LEFT JOIN (
        ...
        FROM GENDB01.FELADM.FEL_RECEIPT_DIM
    ...
    LEFT JOIN (
        ...
        FROM GENDB01.FELADM.FEL_INVTRY_LOC_DIM
    ...
    LEFT JOIN (
        ...
        FROM GENDB01.FELADM.FEL_COMTRAC_CONTRACT_FDR ct
    ...
    LEFT JOIN (
        ...
        FROM GENDB01.FELADM.FEL_CMDTY_SRC_DIM
    ) LKP_CS
...
INSERT INTO GENDB01.FELADM.FEL_COAL_RCPTS_QTY_QLTY_FACT (
    RECEIPT_KEY,
    SHP_DT_ID,
    UNLOADD_DT_ID,
    PRCD_DT_ID,
...
WHERE NOT EXISTS (
    SELECT 1
    FROM GENDB01.FELADM.FEL_COAL_RCPTS_QTY_QLTY_FACT L
