...
--------------------------------------------------------------------------------
 SOURCE    : AEP_DW_RECEIPT_COSTDTL_VW
             GENDB01_DEV_SANDBOX.COMMON.AEP_DW_RECEIPT_COSTDTL_VW_TEST (USED FOR TESTING)
...
FROM (
    ...
    FROM (
        ...
        FROM GENDB01_DEV_SANDBOX.COMMON.AEP_DW_RECEIPT_COSTDTL_VW_TEST SQ  --USED FOR TESTING
