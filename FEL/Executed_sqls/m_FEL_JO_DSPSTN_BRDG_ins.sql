...
--------------------------------------------------------------------------------
 SOURCE    : GENDB01_DEV_SANDBOX.COMMON.AEP_DW_FV_JO_DISPOSED_VW_TEST   
 LOOKUPS   : GENDB01.FELADM.FEL_ACCTG_MONTH_VW
...
TRUNCATE TABLE GENDB01.FELADM.FEL_JO_DSPSTN_BRDG;

INSERT INTO GENDB01.FELADM.FEL_JO_DSPSTN_BRDG (
    ACCTG_MO_DAY_ID,
    TRAN_CLS_LVL_3_NM,
    PERCENT_QY,
    PERCENT_AT,
...
FROM GENDB01_DEV_SANDBOX.COMMON.AEP_DW_FV_JO_DISPOSED_VW_TEST SQ
LEFT JOIN (
...
LEFT JOIN (
 ...
 AND LKP_GU.SYSTEM_ID = (SELECT MIN(SYS_ID) FROM GENDB01.FELADM.FEL_SYSTEM_DIM WHERE SYS_NM = 'COMTRAC')
LEFT JOIN (
