...
--------------------------------------------------------------------------------
 ...
 LOOKUP    : GENDB01.FELADM.FEL_COMTRAC_CNTRCT_OBLGN_FDR
 TARGET    : GENDB01.FELADM.FEL_COMTRAC_CNTRCT_OBLGN_FDR   insert and update instances
--------------------------------------------------------------------------------
...
UPDATE GENDB01.FELADM.FEL_COMTRAC_CNTRCT_OBLGN_FDR TGT
SET
...
FROM (
    ...
    FROM (
        ...
        FROM GENDB01_DEV_SANDBOX.COMMON.AEP_DW_CONTRACT_OBLIGATIONS_VW_TEST SQ  --USED FOR TESTING
    ...
    JOIN (
        ...
        FROM GENDB01.FELADM.FEL_COMTRAC_CNTRCT_OBLGN_FDR FDR
...
INSERT INTO GENDB01.FELADM.FEL_COMTRAC_CNTRCT_OBLGN_FDR (
    CNTRCT_DTL_ID,
    FACILITY_ID,
    CNTRCT_DTL_OPRTG_DT,
    CONTRACT_ID,
