...
--------------------------------------------------------------------------------
 SOURCE    : AEP_DW_FACILITY_VW
             GENDB01_DEV_SANDBOX.COMMON.AEP_DW_FACILITY_VW_TEST (Used for testing)
 LOOKUP    : GENDB01.FELADM.FEL_COMTRAC_FACILITY_FDR
...
UPDATE GENDB01.FELADM.FEL_COMTRAC_FACILITY_FDR TGT
SET
...
FROM (
    ...
    FROM (
        ...
        FROM GENDB01_DEV_SANDBOX.COMMON.AEP_DW_FACILITY_VW_TEST SQ
    ...
    JOIN (
        ...
        FROM GENDB01.FELADM.FEL_COMTRAC_FACILITY_FDR FDR
...
INSERT INTO GENDB01.FELADM.FEL_COMTRAC_FACILITY_FDR (
    FACILITY_ID,
    FACILITY_NM,
    FCLTY_TYPE_NM,
    FCLTY_STAT_TX,
