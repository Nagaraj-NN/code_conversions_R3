...
--------------------------------------------------------------------------------
 SOURCE    : AEP_DW_RECEIPT_VW
             GENDB01_DEV_SANDBOX.COMMON.AEP_DW_RECEIPT_VW_TEST (USED FOR TESTING)
 LOOKUP    : GENDB01.FELADM.FEL_COAL_RCPTS_QTY_QLTY_FDR
 TARGET    : GENDB01.FELADM.FEL_COAL_RCPTS_QTY_QLTY_FDR   insert and update instances
--------------------------------------------------------------------------------
...
UPDATE GENDB01.FELADM.FEL_COAL_RCPTS_QTY_QLTY_FDR TGT
SET
...
FROM (
    ...
    FROM (
        ...
        FROM GENDB01_DEV_SANDBOX.COMMON.AEP_DW_RECEIPT_VW_TEST SQ  --USED FOR TESTING
...
INSERT INTO GENDB01.FELADM.FEL_COAL_RCPTS_QTY_QLTY_FDR (
    RECEIPT_ID,
    CMDTY_SRC_ID,
    SHIPPED_TS,
    UNLOADD_TS,
...
WHERE NOT EXISTS (
    SELECT 1
    FROM GENDB01.FELADM.FEL_COAL_RCPTS_QTY_QLTY_FDR LKP
