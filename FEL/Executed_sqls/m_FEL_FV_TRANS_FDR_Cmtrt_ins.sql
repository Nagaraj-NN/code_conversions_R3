...
--------------------------------------------------------------------------------
 SOURCE    : AEP_DW_FV_TRANS_VW   full read, no filter
             GENDB01_DEV_SANDBOX.COMMON.AEP_DW_FV_TRANS_VW_TEST (USED FOR TESTING)
 LOOKUP    : GENDB01.FELADM.AEP_DATE
 TARGET    : GENDB01.FELADM.FEL_FV_TRANS_FDR   single instance
--------------------------------------------------------------------------------
...
TRUNCATE TABLE GENDB01.FELADM.FEL_FV_TRANS_FDR;

INSERT INTO GENDB01.FELADM.FEL_FV_TRANS_FDR (
    ACCTG_MO_DAY_ID,
    CAL_DAY_ID,
    TRAN_CLS_LVL_1_NM,
    TRAN_CLS_LVL_2_NM,
...
FROM GENDB01_DEV_SANDBOX.COMMON.AEP_DW_FV_TRANS_VW_TEST SQ  --USED FOR TESTING
LEFT JOIN (
